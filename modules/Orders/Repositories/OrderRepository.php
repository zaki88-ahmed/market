...
//        return $this->ApiResponse(200, 'Customer details', null, $orders);
        ...
        $customer_order = Order::with(['orderProduct'])->where('customer_id', auth()->user()->id);
        return $this->ApiResponse(200, 'All Orders', null, OrderResource::collection($customer_order));
    }
